...
function buddyboss_wall_read_filter( $action )
{
  ...
  // this is a fix for forum reply and topic mentions to exclude it from being updated
  if ( $current_activity->component === 'groups' && ( $current_activity->type == 'bbp_reply_create' || $current_activity->type == 'bbp_topic_create' ) ) {
      return $action;
  }
