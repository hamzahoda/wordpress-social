...
= 1.3.8 =
* Fix - When forum reply was created with mention of some username, activity action was changed to a mention that was not the same as the actual bbPress action
