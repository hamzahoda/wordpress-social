    ...
    */
    ...
    public function ddd_getting_started() {
    	...
    	$ddd_starting .='"><!-- .et_pb_on_state || .et_pb_off_state -->
            ...
            if ($ddd_option_template == 'enabled') { $ddd_starting .= '<iframe id="ondemanIframe" name="ondemandIframe" class="settingsIframe" src="https://ondemand.divi-den.com/search-everything/?_sft_post_tag=free"></iframe><div class="saving_message"><h3 class="sectionSaved"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></h3><span class="close">&#x2715;</span></div><div class="loaded_message"><h3 class="sectionSaved">Success! Saved to Divi Library<br>The layout or section has been saved to your Divi Library.<br>Use the "Add From Library" tab in Divi Builder to load it onto a new page.</h3><span class="close">&#x2715;</span></div>'; }
            return $ddd_starting;
    }
    ...
    public function ddd_pro() {
        add_option( 'ddd_enable', 'enabled' );
        $ddd_pro = '';
        $ddd_pro .= '<iframe id="ondemanIframe" name="ondemandIframe" class="settingsIframe" src="https://ondemand.divi-den.com/search-everything/?_sft_post_tag=pro"></iframe><div class="saving_message"><h3 class="sectionSaved"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></h3><span class="close">&#x2715;</span></div><div class="loaded_message"><h3 class="sectionSaved">Success! Saved to Divi Library<br>The layout or section has been saved to your Divi Library.<br>Use the "Add From Library" tab in Divi Builder to load it onto a new page.</h3><span class="close">&#x2715;</span></div>';
            return $ddd_pro;
    }
	...
	public function config_page() {
		$this->report_data($warning_flag = 1);
			$settings_tabs = array(
				...
				'ddd_assistant_help_faq' => 'Give Plugin Feedback'
			);
